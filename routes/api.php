...
Route::middleware(['api'])->domain(env('API_URL'))->prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('wallets')->middleware('log_activity')->group(function () {
            ...
            Route::get('{walletType}/withdrawal-data', [WalletController::class, 'withdrawalData']);
        ...
        Route::prefix('plans')->group(function () {
            ...
            Route::post('{planId}/cancel', [PlanController::class, 'cancelPlan'])->name('plans.cancelPlan');
        });
