    ...
    <div>
        <table border="0" cellspacing="0" cellpadding="0" style="font-size:14px;max-width:600px;margin:auto;background-color:white" width="100%">
            <tbody>
                            ...
                            <tbody>
                                <tr>
                                    <td style="padding:20px 10px 35px">
                                        ...
                                        <ul>
                                            <li><strong>Name:</strong> {{ $property->property_name }}</li>
                                            <li><strong>Address:</strong> {{ $property->property_address }}</li>
                                ...
                                <tr style="height:22px"><td>&nbsp;</td></tr>
                                <tr><td style="border-top:1px dashed rgba(0,0,0,0.08)"></td></tr>
                                <tr style="height:22px"><td>&nbsp;</td></tr>
                                ...
                                <tr><td>Phone : <strong>07015300138</strong></td></tr>
                                <tr>
                                    <td>
                ...
                <tr>
                    <td style="padding:24px 20px; font-size:14px; line-height:18px; background:rgb(0,184,118); color: #fff">
                ...
                <tr>
                    <td align="center" style="padding:30px 0px">
                        <a href="https://web.facebook.com/profile.php?id=100043562603844" target="_blank"><img style="width: 32px;" src="https://files.opayweb.com/images/marketing/activityTemplate/2022-12-05/picf_809.png" alt=""></a>
